<?php $__env->startSection('title', 'Gestion des Comptes Utilisateurs'); ?>
...
<?php $__env->startSection('additionnal_js'); ?>
    ...
    <script>
        const FETCHDATAURL = "<?php echo e(route('admin.user_accounts.fetch_all')); ?>"
        const CURRENTURL = "<?php echo e(route('admin.user_accounts.index')); ?>"
        let rowData = {}
        ...
        $('#editableTable').on('click', '.change-role-btn', function() {
            ...
            $('#confirmAction').off('click').on('click', function() {
                $.ajax({
                    url: "<?php echo e(route('admin.user_accounts.change_role')); ?>", // Route backend
                    type: 'POST',
                    data: {
                        id: rowData.id,
                        is_admin: newState,
...
<?php echo $__env->make('site.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/amanda/Documents/workflow/laravel projects/Gestion de projets/resources/views/site/pages/user/index.blade.php ENDPATH**/ ?>