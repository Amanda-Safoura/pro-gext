<?php $__env->startSection('title', 'Notifications récentes'); ?>
        ...
        $(document).ready(function() {
            ...
            $(document).ready(function() {
                let table = $('#notifs-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "<?php echo e(route('notifs.datas')); ?>",
                    columns: [{
                            data: 'checkbox',
                            name: 'checkbox',
                            orderable: false,
            ...
            function updateReadStatus(isRead, ids = null) {
                ...
                $.ajax({
                    url: "<?php echo e(route('notifs.change-read-status')); ?>",
                    method: 'POST',
                    data: {
...
<?php echo $__env->make('site.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/amanda/Documents/workflow/laravel projects/Gestion de projets/resources/views/site/pages/notifs.blade.php ENDPATH**/ ?>